...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".clock-group[data-v-dc3eaaa8]{display:flex;flex-direction:column;margin:0 auto;justify-content:center;align-items:center}.footer[data-v-dc3eaaa8],.header[data-v-dc3eaaa8]{margin:20px 0}.clock-group.center[data-v-dc3eaaa8]{inset:0;position:absolute;margin:auto}.clock-item[data-v-dc3eaaa8]{height:auto}.swiper-container[data-v-dc3eaaa8]{width:100%}.swiper-container[data-v-dc3eaaa8] .swiper-wrapper{align-items:center;padding-bottom:20px}.swiper-pagination[data-v-dc3eaaa8]:not(.swiper-container-vertical>.swiper-pagination-bullets){bottom:0;line-height:1}.gap[data-v-dc3eaaa8]{display:flex;flex-direction:column;gap:var(--gap)}", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@keyframes shake-5a2794c6{0%{transform:rotate(.5deg)}50%{transform:rotate(-.5deg)}to{transform:rotate(.5deg) scale(1.01)}}.active[data-v-5a2794c6]{animation:shake-5a2794c6 .2s ease infinite}.clock-box[data-v-5a2794c6]{text-align:center;flex-direction:column;gap:calc(var(--size)*.2);height:-moz-fit-content;height:fit-content;margin:0 auto;-webkit-user-select:none;-moz-user-select:none;user-select:none;font-size:min(3vmin,20px);color:#888;text-shadow:0 1px 0 rgba(0,0,0,.3);height:100%;--bg:#333;--font:#fff}.clock[data-v-5a2794c6],.clock-box[data-v-5a2794c6]{display:flex;justify-content:center;align-items:center}.clock[data-v-5a2794c6]{gap:calc(var(--size)*.1);padding:calc(var(--size)*.2);box-sizing:border-box;width:100%}[data-theme=dark] .clock-box[data-v-5a2794c6]{--bg:#fff;--font:#333}.clock-box.center[data-v-5a2794c6]{inset:0;position:absolute;margin:auto}.clock em[data-v-5a2794c6]{display:inline-block;line-height:var(--size);font-size:calc(var(--size)*.666);font-style:normal;vertical-align:top;-webkit-user-select:none;-moz-user-select:none;user-select:none;-webkit-user-drag:none}.contents[data-v-5a2794c6]{display:contents}.flip[data-v-5a2794c6]{display:inline-block;position:relative;width:calc(var(--size)*.666);height:var(--size);line-height:var(--size);border-radius:10%;font-size:calc(var(--size)*.888);color:var(--font);box-shadow:0 0 calc(var(--size)*.05) var(--bg);text-align:center;font-family:Helvetica Neue;font-weight:700;backface-visibility:hidden}.flip .digital[data-v-5a2794c6]:after,.flip .digital[data-v-5a2794c6]:before{content:\"\";position:absolute;left:0;line-height:var(--size);right:0;background:var(--bg);overflow:hidden}.flip .digital[data-v-5a2794c6]:before{top:0;bottom:50%;border-radius:10% 10% 0 0;border-bottom:1px solid lighten(var(--font),10%)}.flip .digital[data-v-5a2794c6]:after{border-top:1px solid lighten(var(--font),10%)}.flip .number0[data-v-5a2794c6]:after,.flip .number0[data-v-5a2794c6]:before{content:\"0\"}.flip .number1[data-v-5a2794c6]:after,.flip .number1[data-v-5a2794c6]:before{content:\"1\"}.flip .number2[data-v-5a2794c6]:after,.flip .number2[data-v-5a2794c6]:before{content:\"2\"}.flip .number3[data-v-5a2794c6]:after,.flip .number3[data-v-5a2794c6]:before{content:\"3\"}.flip .number4[data-v-5a2794c6]:after,.flip .number4[data-v-5a2794c6]:before{content:\"4\"}.flip .number5[data-v-5a2794c6]:after,.flip .number5[data-v-5a2794c6]:before{content:\"5\"}.flip .number6[data-v-5a2794c6]:after,.flip .number6[data-v-5a2794c6]:before{content:\"6\"}.flip .number7[data-v-5a2794c6]:after,.flip .number7[data-v-5a2794c6]:before{content:\"7\"}.flip .number8[data-v-5a2794c6]:after,.flip .number8[data-v-5a2794c6]:before{content:\"8\"}.flip .number9[data-v-5a2794c6]:after,.flip .number9[data-v-5a2794c6]:before{content:\"9\"}.flip .digital[data-v-5a2794c6]:after{top:50%;bottom:0;border-radius:0 0 10% 10%;line-height:0}.flip.down .front[data-v-5a2794c6]:before{z-index:3;transform:translateZ(.3px)}.flip.down .back[data-v-5a2794c6]:after{transform:translateZ(.2px)}.flip.down .back[data-v-5a2794c6]:before,.flip.down .front[data-v-5a2794c6]:after{z-index:1;transform:translateZ(.1px)}.flip.down .back[data-v-5a2794c6]:after{z-index:2;transform-origin:50% 0;transform:perspective(calc(var(--size)*1.5)) rotateX(180deg) translateZ(.2px)}.flip.up .front[data-v-5a2794c6]:after{z-index:3;transform:translateZ(.3px)}.flip.up .back[data-v-5a2794c6]:before{z-index:2;transform-origin:50% 100%;transform:perspective(calc(var(--size)*1.5)) rotateX(-180deg) translateZ(.2px)}.flip.up .back[data-v-5a2794c6]:after,.flip.up .front[data-v-5a2794c6]:before{z-index:1;transform:translateZ(.1px)}.flip.down.go .front[data-v-5a2794c6]:before{transform-origin:50% 100%;animation:frontFlipDown-5a2794c6 .6s ease-in-out both;backface-visibility:hidden}.flip.down.go .back[data-v-5a2794c6]:after{animation:backFlipDown-5a2794c6 .6s ease-in-out both}.flip.down.go .front[data-v-5a2794c6]:after{animation:backShadow-5a2794c6 .6s ease-in-out both}.flip.down.go .back[data-v-5a2794c6]:before{animation:frontShadow-5a2794c6 .6s ease-in-out both}@keyframes frontFlipDown-5a2794c6{0%{filter:brightness(1);transform:perspective(calc(var(--size)*1.5)) rotateX(0deg)}to{filter:brightness(.1);transform:perspective(calc(var(--size)*1.5)) rotateX(-180deg)}}@keyframes backFlipDown-5a2794c6{0%{filter:brightness(.1);transform:perspective(calc(var(--size)*1.5)) rotateX(180deg)}50%{filter:brightness(.8)}to{filter:brightness(1);transform:perspective(calc(var(--size)*1.5)) rotateX(0deg)}}@keyframes frontShadow-5a2794c6{0%{filter:brightness(.1)}70%{filter:brightness(1)}}@keyframes backShadow-5a2794c6{30%{filter:brightness(1)}to{filter:brightness(.1)}}.flip.up.go .front[data-v-5a2794c6]:after{transform-origin:50% 0;animation:frontFlipUp-5a2794c6 .6s ease-in-out both;backface-visibility:hidden}.flip.up.go .back[data-v-5a2794c6]:after{animation:backShadow-5a2794c6 .6s ease-in-out both}.flip.up.go .front[data-v-5a2794c6]:before{animation:frontShadow-5a2794c6 .6s ease-in-out both}.flip.up.go .back[data-v-5a2794c6]:before{animation:backFlipUp-5a2794c6 .6s ease-in-out both}@keyframes frontFlipUp-5a2794c6{0%{transform:perspective(calc(var(--size)*1.5)) rotateX(0deg)}to{transform:perspective(calc(var(--size)*1.5)) rotateX(180deg)}}@keyframes backFlipUp-5a2794c6{0%{transform:perspective(calc(var(--size)*1.5)) rotateX(-180deg)}to{transform:perspective(calc(var(--size)*1.5)) rotateX(0deg)}}", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
// add the styles to the DOM
var add = (__webpack_require__(4402)/* ["default"] */ .Z)
var update = add("bfeb7970", content, true, {"sourceMap":false,"shadowMode":false});
...
// load the styles
var content = __webpack_require__(6135);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(4402)/* ["default"] */ .Z)
var update = add("928d7052", content, true, {"sourceMap":false,"shadowMode":false});
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/babel-loader/lib/index.js!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./plugins/components/FlipClock/index.vue?vue&type=template&id=5a2794c6&scoped=true&
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/babel-loader/lib/index.js!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./plugins/components/ClockGroup/index.vue?vue&type=template&id=dc3eaaa8&scoped=true&
var ClockGroupvue_type_template_id_dc3eaaa8_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
...
var ClockGroupvue_type_template_id_dc3eaaa8_scoped_true_staticRenderFns = [];
...
var ClockGroupvue_type_style_index_0_id_dc3eaaa8_prod_scoped_true_lang_css_ = __webpack_require__(5027);
;// CONCATENATED MODULE: ./plugins/components/ClockGroup/index.vue?vue&type=style&index=0&id=dc3eaaa8&prod&scoped=true&lang=css&
...
var ClockGroup_component = normalizeComponent(
  ...
  ClockGroupvue_type_template_id_dc3eaaa8_scoped_true_render,
  ClockGroupvue_type_template_id_dc3eaaa8_scoped_true_staticRenderFns,
  false,
  null,
  "dc3eaaa8",
  null
