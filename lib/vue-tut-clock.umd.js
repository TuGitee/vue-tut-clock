(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-tut-clock"] = factory();
	else
		root["vue-tut-clock"] = factory();
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".clock-box[data-v-a076fde8]{margin:0;display:flex;flex-direction:column;justify-content:center;gap:calc(var(--size)*.1);align-items:center;position:relative;transition:all .2s ease;--text-color:#333;--border-color:#fff}.clock-box.center[data-v-a076fde8]{inset:0;position:absolute;margin:auto;height:-moz-fit-content;height:fit-content}[data-theme=dark] .clock-box[data-v-a076fde8]{--text-color:#888;--border-color:#111}.clock[data-v-a076fde8]{height:var(--size);width:var(--size);display:flex;justify-content:center;align-items:center;background-color:var(--border-color);background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-position:50%;background-size:cover;border-radius:50%;border:calc(var(--size)/50) solid var(--border-color);box-shadow:0 -15px 15px hsla(0,0%,100%,.05),inset 0 -15px 15px hsla(0,0%,100%,.05),0 15px 15px rgba(0,0,0,.3),inset 0 15px 15px rgba(0,0,0,.3)}.clock[data-v-a076fde8]:before{content:\"\";height:calc(var(--size)*.04);width:calc(var(--size)*.04);background-color:var(--text-color);border:calc(var(--size)*.01) solid var(--border-color);z-index:1000;transition:all .2s ease}.clock[data-v-a076fde8]:before,.hour[data-v-a076fde8],.min[data-v-a076fde8],.sec[data-v-a076fde8]{position:absolute;border-radius:50%}.hour[data-v-a076fde8],.min[data-v-a076fde8],.sec[data-v-a076fde8]{display:flex;justify-content:center}.hour[data-v-a076fde8]{height:calc(var(--size)/2);width:calc(var(--size)/2)}.hour[data-v-a076fde8]:before{content:\"\";position:absolute;height:50%;width:calc(var(--size)/50);background-color:var(--text-color);border-radius:calc(var(--size)/50)}.min[data-v-a076fde8]{height:calc(var(--size)/1.75);width:calc(var(--size)/1.75)}.min[data-v-a076fde8]:before{content:\"\";height:50%;width:calc(var(--size)/100);background-color:var(--text-color);border-radius:calc(var(--size)/100)}.sec[data-v-a076fde8]{height:calc(var(--size)/1.5);width:calc(var(--size)/1.5)}.sec[data-v-a076fde8]:before{content:\"\";height:60%;width:calc(var(--size)/200);background-color:red;border-radius:calc(var(--size)/200)}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@keyframes shake-1adfc25c{0%{transform:rotate(1deg)}50%{transform:rotate(-1deg)}to{transform:rotate(1deg) scale(1.02)}}.active[data-v-1adfc25c]{animation:shake-1adfc25c .2s ease infinite}.clock-box[data-v-1adfc25c]{text-align:center;flex-direction:column;gap:calc(var(--size)*.2);height:-moz-fit-content;height:fit-content;margin:0 auto;-webkit-user-select:none;-moz-user-select:none;user-select:none;font-size:min(3vmin,20px);color:#888;text-shadow:0 1px 0 rgba(0,0,0,.3);height:100%;--bg:#333;--font:#fff}.clock[data-v-1adfc25c],.clock-box[data-v-1adfc25c]{display:flex;justify-content:center;align-items:center}.clock[data-v-1adfc25c]{gap:calc(var(--size)*.1);padding:calc(var(--size)*.2);box-sizing:border-box;width:100%}[data-theme=dark] .clock-box[data-v-1adfc25c]{--bg:#fff;--font:#333}.clock-box.center[data-v-1adfc25c]{inset:0;position:absolute;margin:auto}.clock em[data-v-1adfc25c]{display:inline-block;line-height:var(--size);font-size:calc(var(--size)*.666);font-style:normal;vertical-align:top;-webkit-user-select:none;-moz-user-select:none;user-select:none;-webkit-user-drag:none}.contents[data-v-1adfc25c]{display:contents}.flip[data-v-1adfc25c]{display:inline-block;position:relative;width:calc(var(--size)*.666);height:var(--size);line-height:var(--size);border-radius:10%;font-size:calc(var(--size)*.888);color:var(--font);box-shadow:0 0 calc(var(--size)*.05) var(--bg);text-align:center;font-family:Helvetica Neue;font-weight:700;backface-visibility:hidden;transform-style:preserve-3d}.flip .digital[data-v-1adfc25c]:after,.flip .digital[data-v-1adfc25c]:before{content:\"\";position:absolute;left:0;line-height:var(--size);right:0;background:var(--bg);overflow:hidden}.flip .digital[data-v-1adfc25c]:before{top:0;bottom:50%;border-radius:10% 10% 0 0;border-bottom:1px solid lighten(var(--font),10%)}.flip .digital[data-v-1adfc25c]:after{border-top:1px solid lighten(var(--font),10%)}.flip .number0[data-v-1adfc25c]:after,.flip .number0[data-v-1adfc25c]:before{content:\"0\"}.flip .number1[data-v-1adfc25c]:after,.flip .number1[data-v-1adfc25c]:before{content:\"1\"}.flip .number2[data-v-1adfc25c]:after,.flip .number2[data-v-1adfc25c]:before{content:\"2\"}.flip .number3[data-v-1adfc25c]:after,.flip .number3[data-v-1adfc25c]:before{content:\"3\"}.flip .number4[data-v-1adfc25c]:after,.flip .number4[data-v-1adfc25c]:before{content:\"4\"}.flip .number5[data-v-1adfc25c]:after,.flip .number5[data-v-1adfc25c]:before{content:\"5\"}.flip .number6[data-v-1adfc25c]:after,.flip .number6[data-v-1adfc25c]:before{content:\"6\"}.flip .number7[data-v-1adfc25c]:after,.flip .number7[data-v-1adfc25c]:before{content:\"7\"}.flip .number8[data-v-1adfc25c]:after,.flip .number8[data-v-1adfc25c]:before{content:\"8\"}.flip .number9[data-v-1adfc25c]:after,.flip .number9[data-v-1adfc25c]:before{content:\"9\"}.flip .digital[data-v-1adfc25c]:after{top:50%;bottom:0;border-radius:0 0 10% 10%;line-height:0}.flip.down .front[data-v-1adfc25c]:before{z-index:3;transform:translateZ(.3px)}.flip.down .back[data-v-1adfc25c]:after{transform:translateZ(.2px)}.flip.down .back[data-v-1adfc25c]:before,.flip.down .front[data-v-1adfc25c]:after{z-index:1;transform:translateZ(.1px)}.flip.down .back[data-v-1adfc25c]:after{z-index:2;transform-origin:50% 0;transform:perspective(calc(var(--size)*1.5)) rotateX(180deg) translateZ(.2px)}.flip.up .front[data-v-1adfc25c]:after{z-index:3;transform:translateZ(.3px)}.flip.up .back[data-v-1adfc25c]:before{z-index:2;transform-origin:50% 100%;transform:perspective(calc(var(--size)*1.5)) rotateX(-180deg) translateZ(.2px)}.flip.up .back[data-v-1adfc25c]:after,.flip.up .front[data-v-1adfc25c]:before{z-index:1;transform:translateZ(.1px)}.flip.down.go .front[data-v-1adfc25c]:before{transform-origin:50% 100%;animation:frontFlipDown-1adfc25c .6s ease-in-out both;backface-visibility:hidden}.flip.down.go .back[data-v-1adfc25c]:after{animation:backFlipDown-1adfc25c .6s ease-in-out both;backface-visibility:hidden}.flip.down.go .front[data-v-1adfc25c]:after{animation:backShadow-1adfc25c .6s ease-in-out both}.flip.down.go .back[data-v-1adfc25c]:before{animation:frontShadow-1adfc25c .6s ease-in-out both}@keyframes frontFlipDown-1adfc25c{0%{filter:brightness(1);transform:perspective(calc(var(--size)*1.5)) rotateX(0deg) translateZ(.1px)}to{filter:brightness(.1);transform:perspective(calc(var(--size)*1.5)) rotateX(-180deg) translateZ(.3px)}}@keyframes backFlipDown-1adfc25c{0%{filter:brightness(.1);transform:perspective(calc(var(--size)*1.5)) rotateX(180deg) translateZ(.3px)}50%{filter:brightness(.8)}to{filter:brightness(1);transform:perspective(calc(var(--size)*1.5)) rotateX(0deg) translateZ(.1px)}}@keyframes frontShadow-1adfc25c{0%{filter:brightness(.1)}70%{filter:brightness(1)}}@keyframes backShadow-1adfc25c{30%{filter:brightness(1)}to{filter:brightness(.1)}}.flip.up.go .front[data-v-1adfc25c]:after{transform-origin:50% 0;animation:frontFlipUp-1adfc25c .6s ease-in-out both;backface-visibility:hidden}.flip.up.go .back[data-v-1adfc25c]:after{animation:backShadow-1adfc25c .6s ease-in-out both}.flip.up.go .front[data-v-1adfc25c]:before{animation:frontShadow-1adfc25c .6s ease-in-out both}.flip.up.go .back[data-v-1adfc25c]:before{animation:backFlipUp-1adfc25c .6s ease-in-out both}@keyframes frontFlipUp-1adfc25c{0%{transform:perspective(calc(var(--size)*1.5)) rotateX(0deg)}to{transform:perspective(calc(var(--size)*1.5)) rotateX(180deg)}}@keyframes backFlipUp-1adfc25c{0%{transform:perspective(calc(var(--size)*1.5)) rotateX(-180deg)}to{transform:perspective(calc(var(--size)*1.5)) rotateX(0deg)}}", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
// load the styles
var content = __webpack_require__(8974);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(4402)/* ["default"] */ .Z)
var update = add("f9f35c18", content, true, {"sourceMap":false,"shadowMode":false});
...
// load the styles
var content = __webpack_require__(4283);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(4402)/* ["default"] */ .Z)
var update = add("175a6272", content, true, {"sourceMap":false,"shadowMode":false});
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/babel-loader/lib/index.js!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./plugins/components/FlipClock/index.vue?vue&type=template&id=1adfc25c&scoped=true&
  ...
  mounted() {
    ...
    this.timer = setInterval(() => {
      ...
      for (let i = 0; i < flipObjs.length; i++) {
        ...
        this.deadline ? flipObjs[i].flipDown('number' + nowTimeStr[i], 'number' + nextTimeStr[i]) : flipObjs[i].flipDown('number' + nowTimeStr[i], 'number' + nextTimeStr[i]);
      }
      this.pre.nowTimeStr = nowTimeStr;
      this.pre.nextTimeStr = nextTimeStr;
    }, 1000);
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/babel-loader/lib/index.js!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./plugins/components/CircleClock/index.vue?vue&type=template&id=a076fde8&scoped=true&
var CircleClockvue_type_template_id_a076fde8_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    ref: "clock",
...
var CircleClockvue_type_template_id_a076fde8_scoped_true_staticRenderFns = [];
...
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-54.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-54.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-54.use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-54.use[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./plugins/components/CircleClock/index.vue?vue&type=style&index=0&id=a076fde8&prod&scoped=true&lang=css&
var CircleClockvue_type_style_index_0_id_a076fde8_prod_scoped_true_lang_css_ = __webpack_require__(7369);
;// CONCATENATED MODULE: ./plugins/components/CircleClock/index.vue?vue&type=style&index=0&id=a076fde8&prod&scoped=true&lang=css&
...
var CircleClock_component = normalizeComponent(
  ...
  CircleClockvue_type_template_id_a076fde8_scoped_true_render,
  CircleClockvue_type_template_id_a076fde8_scoped_true_staticRenderFns,
  false,
  null,
  "a076fde8",
  null
...
/* harmony default export */ var components = ([FlipClock, ClockGroup, CircleClock].map(component => ({
  install(Vue) {
